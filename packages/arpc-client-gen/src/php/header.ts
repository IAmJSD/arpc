// https://www.youtube.com/watch?v=rksaoaqt3JA meirl
export default (namespace: string) => `<?php
...
namespace ${namespace}\\Internal {
    class BuiltInError extends \\${namespace}\\BaseException {
...
namespace ${namespace} {
    class InvalidResponse extends \\${namespace}\\Internal\\BuiltInError {}
    \\${namespace}\\Internal\\set_exception(InvalidResponse::class, true);

    class BatchError extends \\${namespace}\\BaseException {
        public array $errors;
...
namespace ${namespace}\\Internal {
    class ClientCore {
        ...
        public function handle_request($request) {
            ...
            if (is_array($response)) {
                ...
                throw new \\${namespace}\\BatchError($response);
            }
            do_throw($response);
        }
    }
    ...
    class BaseBatcher {
        ...
        public function execute(): array {
            return $this->_client->handle_request($this->_batch);
        }
    }
