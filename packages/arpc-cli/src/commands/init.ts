...
To get started, you should make a new API revision. You can do this by running \x1b[36marpc versions create\x1b[0m. After this, if you wish to setup ratelimiting, you can run \x1b[36marpc scaffold ratelimiting\x1b[0m, or authentication with \x1b[36marpc scaffold authentication\x1b[0m.
`);
}
